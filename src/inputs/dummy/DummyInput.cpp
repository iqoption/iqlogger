...
DummyInput::DummyInput(const config::SourceConfig& sourceConfig) :
        Input<Dummy>::Input(sourceConfig)
{
    ...
    INFO("Initialized DUMMY Input with message: `" << m_dummy_text << "` " << " Interval: " << m_interval.count() << " ms.");
}
