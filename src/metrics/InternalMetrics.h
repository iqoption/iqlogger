...
namespace iqlogger::metrics {
    ...
    public:
        ...
        InternalMetrics() :
            ...
            m_clock_tick(sysconf(_SC_CLK_TCK))
        {
        ...
        bool registerInternalMetrics(RegisterCallbackT registerCallbackFunction)
        {
            return
                ...
                registerCallbackFunction("process.cpu_user_seconds_total", [this]() {
                ...
                registerCallbackFunction("process.cpu_system_seconds_total", [this]() {
                ...
                registerCallbackFunction("process.resident_memory_bytes", [this]() {
                ...
                registerCallbackFunction("process.threads", [this]() {
                ...
                registerCallbackFunction("process.open_fds", [this]() {
                ...
                registerCallbackFunction("process.max_fds", [this]() {
